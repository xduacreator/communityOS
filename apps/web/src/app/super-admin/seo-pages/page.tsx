...
export default function SeoPagesAdmin() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      {/* Sidebar - Simple version for snippet */}
      <div className="w-64 bg-slate-900 text-white min-h-screen p-6 shrink-0 hidden md:block">
        ...
        <nav className="space-y-2">
          ...
          <button onClick={() => router.push('/super-admin/seo-pages')} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium bg-indigo-500/10 text-indigo-400 text-left">
            <Globe className="w-4 h-4" />
            SEO Landing Pages
          </button>
          <button onClick={() => router.push('/super-admin/blog')} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-slate-300 hover:text-white hover:bg-slate-800 transition-colors text-left">
